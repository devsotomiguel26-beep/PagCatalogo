-- ============================================================================
-- FIX V4 DEFINITIVO: Convertir created_at a timestamp WITH time zone
-- ============================================================================
-- PROBLEMA: El campo created_at es 'timestamp without time zone'
-- VISTAS DEPENDIENTES (todas las del sistema de earnings):
--   1. active_requests
--   2. pending_earnings
--   3. photographer_earnings_summary
--   4. director_earnings_summary
--   5. settlements_detail (indirecta)
--   6. adjustments_history (indirecta)
--
-- SOLUCIÓN: Eliminar TODAS las vistas, alterar columna, recrear todas
-- ============================================================================

-- ============================================================================
-- PASO 1: Eliminar TODAS las vistas del sistema de earnings
-- ============================================================================
...
COMMENT ON VIEW pending_earnings IS 'Ganancias pendientes - soporta estructuras nueva y antigua (2026-01-19 v4)';
...
COMMENT ON VIEW photographer_earnings_summary IS 'Resumen de ganancias por fotógrafo (v4 soporta ambas estructuras JSON)';

-- Vista 4: director_earnings_summary
...
COMMENT ON VIEW director_earnings_summary IS 'Resumen de ganancias totales del director (v4 soporta ambas estructuras JSON)';

-- Vista 5: settlements_detail
...
--
-- 2. Verificar datos de Hugo Cerda (debe mostrar hora correcta):
-- SELECT
--   client_name,
--   created_at,
...
--
-- 3. Verificar TODAS las vistas recreadas:
...
--
-- 4. Verificar que todas las vistas muestran datos correctos:
-- Todas las vistas deben mostrar ganancias/totales correctos
-- independientemente de si usan estructura JSON nueva o antigua
--
-- ============================================================================
-- FIN DEL SCRIPT - Todas las vistas del sistema de earnings incluidas
-- ============================================================================
