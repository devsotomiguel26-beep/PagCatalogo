        ...
        <table role="presentation" style="width: 100%; max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
          ...
          <tr>
            <td style="padding: 40px 30px;">
              ...
              <div style="background-color: #fff7ed; border-left: 4px solid #f59e0b; padding: 16px; margin: 24px 0; border-radius: 4px;">
                ...
                <ul style="margin: 8px 0 0 0; padding-left: 20px; color: #78350f; font-size: 14px; line-height: 1.6;">
                  <li style="margin-bottom: 8px;">
                    <strong>Los links expiran el ${expirationDate}</strong>
                  </li>
                  <li style="margin-bottom: 8px;">
                    Descarga todas las fotos <strong>HOY</strong> y guárdalas en tu dispositivo
                  </li>
                  <li style="margin-bottom: 8px;">
                    Después de la fecha de expiración, los links dejarán de funcionar
                  </li>
                  <li style="margin-bottom: 8px;">
                    Si tienes problemas para descargar, <strong>responde a este email</strong> antes de que expiren
                  </li>
                  <li>
                    Las fotos están en <strong>alta resolución sin marca de agua</strong>, perfectas para imprimir
                  </li>
                </ul>
              </div>
              ...
              <ol style="margin: 0 0 24px 0; padding-left: 20px; color: #4b5563; font-size: 14px; line-height: 1.8;">
                <li style="margin-bottom: 8px;">
                  Haz clic en cada botón "Descargar" para guardar las fotos
                </li>
                <li style="margin-bottom: 8px;">
                  Guarda las fotos en una carpeta específica (ej: "Fotos ${galleryTitle}")
                </li>
                <li style="margin-bottom: 8px;">
                  Considera hacer un backup en la nube (Google Drive, iCloud, Dropbox)
                </li>
                <li>
                  Las fotos son tuyas para siempre - ¡disfrútalas!
                </li>
              </ol>

              <div style="text-align: center; margin: 32px 0;">
                <p style="margin: 0; color: #6b7280; font-size: 14px; line-height: 1.5;">
                  ¿Necesitas ayuda? <strong>Responde a este email</strong> y te ayudaremos encantados.
                </p>
              </div>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 24px 30px; text-align: center; border-top: 1px solid #e5e7eb;">
              <p style="margin: 0; color: #6b7280; font-size: 12px; line-height: 1.5;">
                Diablos Rojos Foto - Capturando momentos especiales<br>
                Este es un correo automático, responde si necesitas ayuda.
              </p>
            </td>
          </tr>
        </table>
