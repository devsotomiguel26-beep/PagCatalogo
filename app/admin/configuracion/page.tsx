...
export default function ConfiguracionPage() {
  ...
  async function loadGlobalWatermark() {
    ...
    if (!error && data && data.length > 0) {
      ...
      setGlobalWatermarkUrl(urlData.publicUrl + '?t=' + Date.now());
    }
  }
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <Link
          ...
          className="block bg-white rounded-lg shadow hover:shadow-md transition-shadow p-6 border border-gray-200 hover:border-red-300"
        >
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Precios y Descuentos</h3>
              <p className="mt-1 text-sm text-gray-600">
                Configura el precio base por foto y los packs de descuento por volumen
              </p>
            </div>
          </div>
        </Link>

        {/* Card: Marca de Agua (indica que está abajo) */}
        <div className="bg-white rounded-lg shadow p-6 border border-gray-200">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Marca de Agua</h3>
              <p className="mt-1 text-sm text-gray-600">
                Gestiona la marca de agua global para las fotos del catálogo
              </p>
            </div>
          </div>
        </div>
